...
// Type guards
const isRegisterRequest = (body: any): body is RegisterRequest => {
  return (
...
const isLoginRequest = (body: any): body is LoginRequest => {
  return typeof body.email === 'string' && typeof body.password === 'string';
};

const isUpdateProfileRequest = (body: any): body is UpdateProfileRequest => {
  return (
